...
Notre but est d'aider les lycéens a choisir leur orientation dans l'enseignement supérieur. Pour cela nous avons utilise des anciens donnes des anciens étudiants inscrits a l'université et leur résultats pour construire un modèle robuste qui permettait aux étudiant de mieux choisir leur départements ou ils auront le plus de chance de réussir.  Malheureusement le modelé ne donnait pas de résultats performants car il n'y avait pas assez de données sur les étudiants, notamment des données sur leur parcours académique antérieur, leurs résultats aux examens, leurs intérêts et leurs compétences.
Nous avons trouve une alternative pour aider les étudiants a mieux choisir les départements de formation  est de créer une plateforme stremalite et on demande aux étudiants de renseigner leur série de bac leur mention leur année de bac et la mention qu'il vise au bac selon leur niveau Ensuite on les redirige vers un tableau de bord qui leur permet de voir les statistiques des étudiants ayant le même profil qu'eux et les résultats obtenus par ces étudiants.
Cette plateforme permet aux étudiants de mieux comprendre les tendances et les variations saisonnières des résultats des étudiants, et de mieux choisir leur orientation dans l'enseignement supérieur.
...
\end{center}
\textcolor{red}{\faInfoCircle}\textbf{Conclusion :} 
Meme avec cette solution nous avons voulu rajouter d'autres donnes comme le nombre de personnes qui ont fait les demandes d'orientation et le nombre de personnes qui ont été orientées dans chaque département, mais malheureusement nous n'avons pas pu obtenir ces données. 
Nous avons donc décidé de nous concentrer sur les données disponibles et de créer une plateforme qui permet aux étudiants de mieux comprendre les tendances et les variations saisonnières des résultats des étudiants, et de mieux choisir leur orientation dans l'enseignement supérieur.
Cette plateforme permet aux étudiants de mieux comprendre les tendances et les variations saisonnières des résultats des étudiants, et de mieux choisir leur orientation dans l'enseignement supérieur.
